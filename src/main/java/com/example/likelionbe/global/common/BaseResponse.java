package com.example.likelionbe.global.common;
...
public class BaseResponse<T> {
    ...
    public static <T> BaseResponse<T> success(Object code, String message, T data) {
        return new BaseResponse<>(true, code, message, data);
    }

    public static <T> BaseResponse<T> error(Object code, String message) {
